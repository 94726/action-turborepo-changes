...
function getChangedPackages(from = 'HEAD^1', to = '', options = {}) {
    ...
    const json = (0, child_process_1.execSync)(`pnpm turbo run ${pipeline} --filter="...[${from}...${to}]" --dry-run=json`, {
...
function run() {
    try {
        ...
        (0, core_1.debug)(`Finding changes with inputs: ${JSON.stringify({
            from,
            to,
            pipeline,
            workingDirectory,
        ...
        (0, core_1.debug)(`Changed packages: ${changedWorkspaces}`);
        (0, core_1.setOutput)('changed', changedWorkspaces);
    }
    catch (error) {
